...
public class StatusRestController {
  ...
  public void saveStatus(@RequestBody StatusDTO statusDTO) throws Exception {
    try {
  ...
  public void deleteStatus(@PathVariable("code") String code) throws Exception {
    try {
  ...
  public void updateStatus(@RequestBody StatusDTO statusDTO) throws Exception {
    try {
      Status status = statusMapper.statusDTOToStatus(statusDTO);
  ...
  public StatusDTO getStatus(@PathVariable("code") String code) throws Exception {
    try {
      Status status = businessDelegatorView.getStatus(code);
