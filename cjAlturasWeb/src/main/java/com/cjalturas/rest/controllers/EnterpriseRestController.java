...
public class EnterpriseRestController {
  ...
  public void saveEnterprise(@RequestBody EnterpriseDTO enterpriseDTO) throws Exception {
    try {
  ...
  public void deleteEnterprise(@PathVariable("idEnterprise") Integer idEnterprise) throws Exception {
    try {
  ...
  public void updateEnterprise(@RequestBody EnterpriseDTO enterpriseDTO) throws Exception {
    try {
      Enterprise enterprise = enterpriseMapper.enterpriseDTOToEnterprise(enterpriseDTO);
  ...
  public EnterpriseDTO getEnterprise(@PathVariable("idEnterprise") Integer idEnterprise) throws Exception {
    try {
      Enterprise enterprise = businessDelegatorView.getEnterprise(idEnterprise);
