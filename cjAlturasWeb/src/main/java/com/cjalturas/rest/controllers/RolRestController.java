...
public class RolRestController {
  ...
  public void saveRol(@RequestBody RolDTO rolDTO) throws Exception {
    try {
  ...
  public void deleteRol(@PathVariable("codeRol") String codeRol) throws Exception {
    try {
  ...
  public void updateRol(@RequestBody RolDTO rolDTO) throws Exception {
    try {
      Rol rol = rolMapper.rolDTOToRol(rolDTO);
  ...
  public RolDTO getRol(@PathVariable("codeRol") String codeRol) throws Exception {
    try {
      Rol rol = businessDelegatorView.getRol(codeRol);
