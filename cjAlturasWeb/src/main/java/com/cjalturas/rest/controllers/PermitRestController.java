...
public class PermitRestController {
  ...
  public void savePermit(@RequestBody PermitDTO permitDTO) throws Exception {
    try {
  ...
  public void deletePermit(@PathVariable("idPermit") Integer idPermit) throws Exception {
    try {
  ...
  public void updatePermit(@RequestBody PermitDTO permitDTO) throws Exception {
    try {
      Permit permit = permitMapper.permitDTOToPermit(permitDTO);
  ...
  public PermitDTO getPermit(@PathVariable("idPermit") Integer idPermit) throws Exception {
    try {
      Permit permit = businessDelegatorView.getPermit(idPermit);
