...
public class CourseRestController {
  ...
  public void saveCourse(@RequestBody CourseDTO courseDTO) throws Exception {
    try {
  ...
  public void deleteCourse(@PathVariable("idCourse") Integer idCourse) throws Exception {
    try {
  ...
  public CourseDTO getCourse(@PathVariable("idCourse") Integer idCourse) throws Exception {
    try {
      Course course = businessDelegatorView.getCourse(idCourse);
