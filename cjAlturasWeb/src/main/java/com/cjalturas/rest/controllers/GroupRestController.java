...
public class GroupRestController {
    ...
    public void saveGroup(@RequestBody
    ...
    public void deleteGroup(@PathVariable("idGroup")
    Integer idGroup) throws Exception {
        try {
    ...
    public void updateGroup(@RequestBody
    GroupDTO groupDTO) throws Exception {
        try {
            Group group = groupMapper.groupDTOToGroup(groupDTO);
    ...
    public GroupDTO getGroup(@PathVariable("idGroup")
    Integer idGroup) throws Exception {
        try {
            Group group = businessDelegatorView.getGroup(idGroup);
