...
public class PersonRestController {
  ...
  public void savePerson(@RequestBody PersonDTO personDTO) throws Exception {
    try {
  ...
  public void deletePerson(@PathVariable("idPerson") Integer idPerson) throws Exception {
    try {
  ...
  public void updatePerson(@RequestBody PersonDTO personDTO) throws Exception {
    try {
      Person person = personMapper.personDTOToPerson(personDTO);
  ...
  public PersonDTO getPerson(@PathVariable("idPerson") Integer idPerson) throws Exception {
    try {
      Person person = businessDelegatorView.getPerson(idPerson);
