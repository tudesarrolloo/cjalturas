...
public class CoachRestController {
  ...
  public void saveCoach(@RequestBody CoachDTO coachDTO) throws Exception {
    try {
  ...
  public void deleteCoach(@PathVariable("idCoach") Integer idCoach) throws Exception {
    try {
  ...
  public void updateCoach(@RequestBody CoachDTO coachDTO) throws Exception {
    try {
      Coach coach = coachMapper.coachDTOToCoach(coachDTO);
  ...
  public CoachDTO getCoach(@PathVariable("idCoach") Integer idCoach) throws Exception {
    try {
      Coach coach = businessDelegatorView.getCoach(idCoach);
