...
public class EconomicsectorRestController {
  ...
  public void saveEconomicsector(@RequestBody EconomicsectorDTO economicsectorDTO) throws Exception {
    try {
  ...
  public void deleteEconomicsector(@PathVariable("idEconomicSector") Integer idEconomicSector) throws Exception {
    try {
  ...
  public void updateEconomicsector(@RequestBody EconomicsectorDTO economicsectorDTO) throws Exception {
    try {
      Economicsector economicsector = economicsectorMapper.economicsectorDTOToEconomicsector(economicsectorDTO);
  ...
  public EconomicsectorDTO getEconomicsector(@PathVariable("idEconomicSector") Integer idEconomicSector) throws Exception {
    try {
      Economicsector economicsector = businessDelegatorView.getEconomicsector(idEconomicSector);
