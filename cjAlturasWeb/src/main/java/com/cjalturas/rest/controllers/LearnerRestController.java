...
public class LearnerRestController {
    ...
    public void saveLearner(@RequestBody
    LearnerDTO learnerDTO) throws Exception {
        try {
    ...
    public void deleteLearner(@PathVariable("idLearner")
    Integer idLearner) throws Exception {
        try {
    ...
    public void updateLearner(@RequestBody
    LearnerDTO learnerDTO) throws Exception {
        try {
            Learner learner = learnerMapper.learnerDTOToLearner(learnerDTO);
    ...
    public LearnerDTO getLearner(@PathVariable("idLearner")
    Integer idLearner) throws Exception {
        try {
            Learner learner = businessDelegatorView.getLearner(idLearner);
