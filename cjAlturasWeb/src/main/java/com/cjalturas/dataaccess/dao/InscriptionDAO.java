 ...
 * Inscription entities. Transaction control of the save(), update() and
...
public class InscriptionDAO extends HibernateDaoImpl<Inscription, Integer>
    implements IInscriptionDAO {
    private static final Logger log = LoggerFactory.getLogger(InscriptionDAO.class);
    @Resource
    private SessionFactory sessionFactory;

    public static IInscriptionDAO getFromApplicationContext(
