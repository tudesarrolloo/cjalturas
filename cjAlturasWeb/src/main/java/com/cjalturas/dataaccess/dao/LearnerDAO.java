...
/**
 * A data access object (DAO) providing persistence and search support for Learner entities. Transaction control of the save(), update() and delete() operations
...
public class LearnerDAO extends HibernateDaoImpl<Learner, Integer> implements ILearnerDAO {
  private static final Logger log = LoggerFactory.getLogger(LearnerDAO.class);

  @Resource
  private SessionFactory sessionFactory;

  public static ILearnerDAO getFromApplicationContext(ApplicationContext ctx) {
    return (ILearnerDAO) ctx.getBean("LearnerDAO");
  }
}
