...
public class LearnerLogic implements ILearnerLogic {
  ...
  public List<Learner> getLearner() throws Exception {
    ...
    try {
      ...
      throw new ZMessManager().new GettingException(ZMessManager.ALL + "Learner");
    } finally {
    }
  ...
  public void deleteLearner(Learner entity) throws Exception {
    ...
    try {
      inscriptions = inscriptionDAO.findByProperty("learner.idLearner", entity.getIdLearner());
  ...
  public List<Learner> findPageLearner(String sortColumnName, boolean sortAscending, int startRow, int maxResults) throws Exception {
    ...
    try {
      entity = learnerDAO.findPage(sortColumnName, sortAscending, startRow, maxResults);
    } catch (Exception e) {
