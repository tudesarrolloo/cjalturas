...
public class PersonLogic implements IPersonLogic {
    ...
    */
    ...
    public void deletePerson(Person entity) throws Exception {
        ...
        try {
            coaches = coachDAO.findByProperty("person.idPerson",
                    entity.getIdPerson());
            ...
            learners = learnerDAO.findByProperty("person.idPerson",
                    entity.getIdPerson());
            ...
            users = userDAO.findByProperty("person.idPerson",
                    entity.getIdPerson());
    ...
    public List<Person> findPagePerson(String sortColumnName,
        ...
        try {
            entity = personDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            ...
            * ejempolo: a > 1 and a < 5 --> 1 seria value y 5 seria value2
                ...
                * ejemplo: a comparator1 1 and a < 5
                    ...
                    * ejemplo: a comparador1>1  and a comparador2<5  (el original: a > 1 and a <
                            ...
                            */
    @Transactional(readOnly = true)
    public List<Person> findByCriteria(Object[] variables,
