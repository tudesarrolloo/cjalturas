    ...
    */
    ...
    public void saveEnterprise(Enterprise entity) throws Exception {
        ...
        try {
            ...
            if (getEnterprise(entity.getIdEnterprise()) != null) {
    ...
    public void deleteEnterprise(Enterprise entity) throws Exception {
        ...
        try {
            learners = learnerDAO.findByProperty("enterprise.idEnterprise",
    ...
    public List<Enterprise> findPageEnterprise(String sortColumnName,
        ...
        try {
            entity = enterpriseDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
