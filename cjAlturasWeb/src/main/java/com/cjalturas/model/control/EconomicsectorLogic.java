...
public class EconomicsectorLogic implements IEconomicsectorLogic {
    ...
    */
    ...
    public void deleteEconomicsector(Economicsector entity)
        ...
        try {
            learners = learnerDAO.findByProperty("economicsector.idEconomicSector",
                    entity.getIdEconomicSector());
    ...
    public List<Economicsector> findPageEconomicsector(String sortColumnName,
        ...
        try {
            entity = economicsectorDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException(
                "Economicsector Count");
        } finally {
        }
