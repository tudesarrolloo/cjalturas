...
public class EconomicsectorView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (idEconomicSector != null)
                ? businessDelegatorView.getEconomicsector(idEconomicSector) : null;
        } catch (Exception e) {
            entity = null;
        }
    ...
    public String action_edit(ActionEvent evt) {
        selectedEconomicsector = (EconomicsectorDTO) (evt.getComponent()
                                                         .getAttributes()
                                                         .get("selectedEconomicsector"));
    ...
    public String action_modifyWitDTO(String economicSector,
