...
public class LearnerView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (idLearner != null)
                ? businessDelegatorView.getLearner(idLearner) : null;
        } catch (Exception e) {
            entity = null;
        }
        ...
        if (entity == null) {
            ...
            txtIdEconomicSector_Economicsector.setValue(entity.getEconomicsector()
                                                              .getIdEconomicSector());
            txtIdEconomicSector_Economicsector.setDisabled(false);
            txtIdEnterprise_Enterprise.setValue(entity.getEnterprise()
                                                      .getIdEnterprise());
            txtIdEnterprise_Enterprise.setDisabled(false);
    ...
    public String action_edit(ActionEvent evt) {
        selectedLearner = (LearnerDTO) (evt.getComponent().getAttributes()
                                           .get("selectedLearner"));
    ...
    public String action_create() {
        try {
            ...
            entity.setEconomicsector((FacesUtils.checkInteger(
                    txtIdEconomicSector_Economicsector) != null)
                ? businessDelegatorView.getEconomicsector(
                    FacesUtils.checkInteger(txtIdEconomicSector_Economicsector))
                : null);
            entity.setEnterprise((FacesUtils.checkInteger(
                    txtIdEnterprise_Enterprise) != null)
                ? businessDelegatorView.getEnterprise(FacesUtils.checkInteger(
                        txtIdEnterprise_Enterprise)) : null);
            entity.setPerson((FacesUtils.checkInteger(txtIdPerson_Person) != null)
                ? businessDelegatorView.getPerson(FacesUtils.checkInteger(
                        txtIdPerson_Person)) : null);
    ...
    public String action_modifyWitDTO(Integer idLearner,
        Integer idEconomicSector_Economicsector,
        Integer idEnterprise_Enterprise, Integer idPerson_Person)
        throws Exception {
        try {
            businessDelegatorView.updateLearner(entity);
            FacesUtils.addInfoMessage(ZMessManager.ENTITY_SUCCESFULLYMODIFIED);
    ...
    public void setTxtIdEconomicSector_Economicsector(
        InputText txtIdEconomicSector_Economicsector) {
    ...
    public void setTxtIdEnterprise_Enterprise(
        InputText txtIdEnterprise_Enterprise) {
