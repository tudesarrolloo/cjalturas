...
public class UserView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (idUser != null) ? businessDelegatorView.getUser(idUser)
                                      : null;
        } catch (Exception e) {
            entity = null;
        }
    ...
    public String action_edit(ActionEvent evt) {
        selectedUser = (UserDTO) (evt.getComponent().getAttributes()
                                     .get("selectedUser"));
    ...
    public String action_modifyWitDTO(String enabled, Integer idUser,
        String password, String username, Integer idPerson_Person,
