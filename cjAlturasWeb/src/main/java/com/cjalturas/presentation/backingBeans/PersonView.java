...
public class PersonView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (idPerson != null)
                ? businessDelegatorView.getPerson(idPerson) : null;
        } catch (Exception e) {
            entity = null;
        }
    ...
    public String action_edit(ActionEvent evt) {
        selectedPerson = (PersonDTO) (evt.getComponent().getAttributes()
                                         .get("selectedPerson"));
    ...
    public String action_modifyWitDTO(String document, String documentType,
        String email, Integer idPerson, String lastname, String name,
