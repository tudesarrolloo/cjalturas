...
public class PermitView implements Serializable {
  ...
  public void listener_txtId() {
    try {
      ...
      entity = (idPermit != null) ? businessDelegatorView.getPermit(idPermit) : null;
    } catch (Exception e) {
      entity = null;
    }
  ...
  public String action_edit(ActionEvent evt) {
    selectedPermit = (PermitDTO) (evt.getComponent().getAttributes().get("selectedPermit"));
  ...
  public String action_modifyWitDTO(Integer idPermit, String resource, String codeRol_Rol) throws Exception {
    try {
