...
public class InscriptionView implements Serializable {
  ...
  public void listener_txtId() {
    try {
      ...
      entity = (idInscription != null) ? businessDelegatorView.getInscription(idInscription) : null;
    } catch (Exception e) {
      entity = null;
    }
  ...
  public String action_edit(ActionEvent evt) {
    selectedInscription = (InscriptionDTO) (evt.getComponent().getAttributes().get("selectedInscription"));
  ...
  public String action_create() {
    try {
      ...
      entity.setDateCertification(FacesUtils.checkDate(txtDateCertification));
      entity.setDateInscription(FacesUtils.checkDate(txtDateInscription));
      entity.setIdInscription(idInscription);
      entity.setGroup((FacesUtils.checkInteger(txtIdGroup_Group) != null) ? businessDelegatorView.getGroup(FacesUtils.checkInteger(txtIdGroup_Group)) : null);
      entity.setLearner(
          (FacesUtils.checkInteger(txtIdLearner_Learner) != null) ? businessDelegatorView.getLearner(FacesUtils.checkInteger(txtIdLearner_Learner)) : null);
      entity.setStatus((FacesUtils.checkString(txtCode_Status) != null) ? businessDelegatorView.getStatus(FacesUtils.checkString(txtCode_Status)) : null);
  ...
  public String action_modifyWitDTO(Date dateCertification, Date dateInscription, Integer idInscription, Integer idGroup_Group, Integer idLearner_Learner,
      String code_Status) throws Exception {
    try {
