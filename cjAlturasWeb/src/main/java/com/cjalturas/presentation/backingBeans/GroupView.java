...
public class GroupView implements Serializable {
    ...
    public void listener_txtId() {
        try {
            ...
            entity = (idGroup != null)
                ? businessDelegatorView.getGroup(idGroup) : null;
        } catch (Exception e) {
            entity = null;
        }
    ...
    public String action_edit(ActionEvent evt) {
        selectedGroup = (GroupDTO) (evt.getComponent().getAttributes()
                                       .get("selectedGroup"));
    ...
    public String action_create() {
        try {
            ...
            entity.setCoach((FacesUtils.checkInteger(txtIdCoach_Coach) != null)
                ? businessDelegatorView.getCoach(FacesUtils.checkInteger(
                        txtIdCoach_Coach)) : null);
            entity.setCourse((FacesUtils.checkInteger(txtIdCourse_Course) != null)
                ? businessDelegatorView.getCourse(FacesUtils.checkInteger(
                        txtIdCourse_Course)) : null);
    ...
    public String action_modifyWitDTO(Date dateStart, Integer idGroup,
        String observations, Integer idCoach_Coach, Integer idCourse_Course)
        throws Exception {
        try {
