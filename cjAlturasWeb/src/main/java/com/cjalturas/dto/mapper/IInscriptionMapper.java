...
public interface IInscriptionMapper {
  ...
  public List<InscriptionDTO> listInscriptionToListInscriptionDTO(List<Inscription> inscriptions) throws Exception;

  public List<Inscription> listInscriptionDTOToListInscription(List<InscriptionDTO> inscriptionDTOs) throws Exception;
}
