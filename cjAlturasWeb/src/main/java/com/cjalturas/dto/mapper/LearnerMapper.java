...
public class LearnerMapper implements ILearnerMapper {
    ...
    */
    ...
    public LearnerDTO learnerToLearnerDTO(Learner learner)
        ...
        try {
            ...
            if (learner.getEconomicsector() != null) {
                learnerDTO.setIdEconomicSector_Economicsector(learner.getEconomicsector()
                                                                     .getIdEconomicSector());
            } else {
            ...
            if (learner.getEnterprise() != null) {
                learnerDTO.setIdEnterprise_Enterprise(learner.getEnterprise()
                                                             .getIdEnterprise());
            } else {
                learnerDTO.setIdEnterprise_Enterprise(null);
            }

            learnerDTO.setIdPerson_Person((learner.getPerson().getIdPerson() != null)
                ? learner.getPerson().getIdPerson() : null);
    ...
    @Transactional(readOnly = true)
    public List<LearnerDTO> listLearnerToListLearnerDTO(
        List<Learner> listLearner) throws Exception {
        try {
    ...
    public List<Learner> listLearnerDTOToListLearner(
        List<LearnerDTO> listLearnerDTO) throws Exception {
        try {
