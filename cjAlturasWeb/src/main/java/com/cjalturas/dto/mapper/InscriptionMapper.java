    ...
    */
    ...
    public InscriptionDTO inscriptionToInscriptionDTO(Inscription inscription)
        ...
        try {
            ...
            inscriptionDTO.setIdGroup_Group((inscription.getGroup().getIdGroup() != null)
                ? inscription.getGroup().getIdGroup() : null);
            inscriptionDTO.setIdLearner_Learner((inscription.getLearner()
                                                            .getIdLearner() != null)
                ? inscription.getLearner().getIdLearner() : null);
            inscriptionDTO.setCode_Status((inscription.getStatus().getCode() != null)
                ? inscription.getStatus().getCode() : null);
    ...
    public List<InscriptionDTO> listInscriptionToListInscriptionDTO(
        List<Inscription> listInscription) throws Exception {
        try {
    ...
    public List<Inscription> listInscriptionDTOToListInscription(
        List<InscriptionDTO> listInscriptionDTO) throws Exception {
        try {
