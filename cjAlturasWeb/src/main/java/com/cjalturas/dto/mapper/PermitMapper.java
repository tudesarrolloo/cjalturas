...
public class PermitMapper implements IPermitMapper {
  ...
  public PermitDTO permitToPermitDTO(Permit permit) throws Exception {
    try {
      ...
      permitDTO.setResource((permit.getResource() != null) ? permit.getResource() : null);
      permitDTO.setCodeRol_Rol((permit.getRol().getCodeRol() != null) ? permit.getRol().getCodeRol() : null);
  ...
  public Permit permitDTOToPermit(PermitDTO permitDTO) throws Exception {
    try {
      ...
      permit.setResource((permitDTO.getResource() != null) ? permitDTO.getResource() : null);
  ...
  @Transactional(readOnly = true)
  public List<PermitDTO> listPermitToListPermitDTO(List<Permit> listPermit) throws Exception {
    try {
  ...
  @Transactional(readOnly = true)
  public List<Permit> listPermitDTOToListPermit(List<PermitDTO> listPermitDTO) throws Exception {
    try {
