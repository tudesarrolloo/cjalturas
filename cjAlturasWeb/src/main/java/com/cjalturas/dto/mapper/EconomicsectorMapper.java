...
public class EconomicsectorMapper implements IEconomicsectorMapper {
    ...
    public EconomicsectorDTO economicsectorToEconomicsectorDTO(
        ...
        try {
            ...
            economicsectorDTO.setEconomicSector((economicsector.getEconomicSector() != null)
                ? economicsector.getEconomicSector() : null);
    ...
    public Economicsector economicsectorDTOToEconomicsector(
        ...
        try {
            ...
            economicsector.setEconomicSector((economicsectorDTO.getEconomicSector() != null)
                ? economicsectorDTO.getEconomicSector() : null);
    ...
    public List<EconomicsectorDTO> listEconomicsectorToListEconomicsectorDTO(
        List<Economicsector> listEconomicsector) throws Exception {
        try {
    ...
    public List<Economicsector> listEconomicsectorDTOToListEconomicsector(
        List<EconomicsectorDTO> listEconomicsectorDTO)
        throws Exception {
        try {
