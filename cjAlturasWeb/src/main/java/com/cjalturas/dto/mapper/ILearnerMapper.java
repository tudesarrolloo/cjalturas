...
public interface ILearnerMapper {
  ...
  public List<LearnerDTO> listLearnerToListLearnerDTO(List<Learner> learners) throws Exception;

  public List<Learner> listLearnerDTOToListLearner(List<LearnerDTO> learnerDTOs) throws Exception;
}
