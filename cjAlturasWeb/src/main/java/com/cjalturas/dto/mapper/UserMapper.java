    ...
    */
    ...
    public UserDTO userToUserDTO(User user) throws Exception {
        try {
            ...
            userDTO.setEnabled((user.getEnabled() != null) ? user.getEnabled()
                                                           : null);
            userDTO.setPassword((user.getPassword() != null)
                ? user.getPassword() : null);
            userDTO.setUsername((user.getUsername() != null)
                ? user.getUsername() : null);
            userDTO.setIdPerson_Person((user.getPerson().getIdPerson() != null)
                ? user.getPerson().getIdPerson() : null);
            userDTO.setCodeRol_Rol((user.getRol().getCodeRol() != null)
                ? user.getRol().getCodeRol() : null);
    ...
    public User userDTOToUser(UserDTO userDTO) throws Exception {
        try {
            ...
            user.setUsername((userDTO.getUsername() != null)
    ...
    @Transactional(readOnly = true)
    public List<User> listUserDTOToListUser(List<UserDTO> listUserDTO)
        throws Exception {
        try {
