...
public interface IGroupMapper {
  ...
  public List<GroupDTO> listGroupToListGroupDTO(List<Group> groups) throws Exception;

  public List<Group> listGroupDTOToListGroup(List<GroupDTO> groupDTOs) throws Exception;
}
